...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/+Wb5L5VZhaAA3MDhl'),
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://t.me/+F-Gwxff2ITU1ZDk1')
                 ]]
        reply_markup=InlineKeyboardMarkup(buttons)
            ...
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_photo(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           InlineKeyboardButton('ᴘʀᴇᴍɪᴜᴍ', url='https://t.me/ContentmebkpBot'),
                                                                           InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://t.me/+F-Gwxff2ITU1ZDk1')
                                                                        ]]
                                                 ),
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/+F-Gwxff2ITU1ZDk1')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def disable_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/funnyzilla')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        await bot.send_message(
            chat_id=chat_, 
